...
let commandsTxt = `<p>Available commands<br/><br/><strong>~ <span class="text-pink">about</span></strong><br/><strong>~ <span class="text-pink">values</span></strong><br/><strong>~ <span class="text-pink">join</span></strong><br/><strong>~ <span class="text-pink">ide</span></strong></p>`;
...
let ideTxt = document.querySelector('[text-type="ide"]').innerHTML;
...
function handleCommand(command) {
  switch (command) {
    ...
    case "join":
      ...
      break;
    case "ide":
      outputDiv.innerHTML += ideTxt + dividerTxt + commandsTxt;
      break;
    default:
