...
let commandsTxt = `<p>Available commands<br/><br/><strong>~ <span class="text-pink">about</span></strong><br/><strong>~ <span class="text-pink">values</span></strong><br/><strong>~ <span class="text-pink">join</span></strong><br/><strong>~ <span class="text-pink">api</span></strong></p>`;
...
let apiTxt = document.querySelector('[text-type="api"]').innerHTML;
...
function handleCommand(command) {
  switch (command) {
    ...
    case "join":
      ...
      break;
    case "api":
      outputDiv.innerHTML += apiTxt + dividerTxt + commandsTxt;
      break;
    default:
